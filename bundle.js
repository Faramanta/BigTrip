...
class API {
  ...
  getPoints() {
    return this._load({
      url: _const_js__WEBPACK_IMPORTED_MODULE_1__["URL"].POINTS
    })
    .then((response) => response.json())
    .then(_models_point_js__WEBPACK_IMPORTED_MODULE_0__["default"].parsePoints);
  }

  getDestinations() {
    return this._load({
      url: _const_js__WEBPACK_IMPORTED_MODULE_1__["URL"].DESTINATIONS
    })
    .then((response) => response.json());
  }
  ...
  getOffers() {
    return this._load({
      url: _const_js__WEBPACK_IMPORTED_MODULE_1__["URL"].OFFERS
    })
    .then((response) => response.json());
  }
  ...
  createPoint(point) {
    ...
    .then((response) => response.json())
    .then(_models_point_js__WEBPACK_IMPORTED_MODULE_0__["default"].parsePoint);
  }

  updatePoint(id, point) {
    return this._load({
      url: `${_const_js__WEBPACK_IMPORTED_MODULE_1__["URL"].POINTS}/${id}`,
  ...
  deletePoint(id) {
    return this._load({url: `${_const_js__WEBPACK_IMPORTED_MODULE_1__["URL"].POINTS}/${id}`, method: _const_js__WEBPACK_IMPORTED_MODULE_1__["Method"].DELETE});
  }

  sync(data) {
    return this._load({
      url: `${_const_js__WEBPACK_IMPORTED_MODULE_1__["URL"].POINTS}/sync`,
      method: _const_js__WEBPACK_IMPORTED_MODULE_1__["Method"].POST,
...
class Provider {
  ...
  getPoints() {
    ...
    return Promise.resolve(_models_point_js__WEBPACK_IMPORTED_MODULE_0__["default"].parsePoints(storePoints));
  }
  ...
  createPoint(point) {
    ...
    const localNewPoint = _models_point_js__WEBPACK_IMPORTED_MODULE_0__["default"].clone(Object.assign(point, {id: localNewPointId}));
  ...
  updatePoint(id, point) {
    ...
    const localPoint = _models_point_js__WEBPACK_IMPORTED_MODULE_0__["default"].clone(Object.assign(point, {id}));
...
const createTripDayItemTemplate = (timestamp, index) => {
  ...
  const monthName = _const_js__WEBPACK_IMPORTED_MODULE_1__["MONTHS"][month];
...
const createMenuTemplate = () => {
  return (
    `<nav class="trip-controls__trip-tabs  trip-tabs">
      <a class="trip-tabs__btn trip-tabs__btn--active" href="#" data-menu-item="${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].TABLE}">Table</a>
      <a class="trip-tabs__btn" data-menu-item="${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].STATS}" href="#">Stats</a>
    </nav>`
  );
};
...
const createOffersSelectorMarkup = (offersTypeAllOnly, pointOffers, id) => {
  ...
  return offersTypeAllOnly
    .map((offerTypeAllOnly) => {
      ...
      const offerUID = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["getOfferUID"])(offerTypeAllOnly.title, offerTypeAllOnly.price, id);
...
const createButtonsMarkup = (mode, id, isFavorite, deleteButtonText) => {
  return mode !== _const_js__WEBPACK_IMPORTED_MODULE_1__["Mode"].ADDING ? (
...
const createTripPointEditTemplate = (point, pointType, pointDestination, offers, destinations, mode, renderOptions) => {
  ...
  const offersTypeAll = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["getTypeOffers"])(offers, pointType); // все офферы типа

  const pointTypeName = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["capitalizeFirstLetter"])(pointType);
  const pointStart = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["getPointTime"])(startTimestamp); // время старта
  const pointEnd = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["getPointTime"])(endTimestamp); // время финиша
  const pointTypesTransferMarkup = createPointTypesMarkup(_const_js__WEBPACK_IMPORTED_MODULE_1__["POINT_TYPES_TRANSPORT"].slice(), id, pointType);
  const pointTypesActivityMarkup = createPointTypesMarkup(_const_js__WEBPACK_IMPORTED_MODULE_1__["POINT_TYPES_ACTIVITY"].slice(), id, pointType);
...
class PointEdit extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(point, offers, destinations, mode) {
    ...
    this._mode = mode;
    this._renderOptions = _const_js__WEBPACK_IMPORTED_MODULE_1__["DefaultData"];
  ...
  _createFlatpickr(inputField, date) {
    return flatpickr__WEBPACK_IMPORTED_MODULE_3___default()(inputField, {
      altInput: true,
      allowInput: true,
      enableTime: true,
      altFormat: `d/m/y H:i`,
...
const createOffersMarkup = (offers) => {
  return offers ? offers.slice(0, _const_js__WEBPACK_IMPORTED_MODULE_2__["OFFERS_SHOWING"])
    .map((offer) => {
      return (
...
const createTripPointTemplate = (point) => {
  ...
  const pointTypeName = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["capitalizeFirstLetter"])(pointType);
  const pointStart = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getPointTime"])(startTimestamp); // время старта
  const pointEnd = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getPointTime"])(endTimestamp); // время финиша
  const pointISOStart = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getPointISOTime"])(startTimestamp);
  const pointISOEnd = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getPointISOTime"])(endTimestamp);

  const pointDur = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getPointDurationFormat"])(startTimestamp, endTimestamp);
...
class Point extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(point) {
    super();
...
class Points extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
  ...
  return (
    `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
      ...
      <div class="trip-sort__item  trip-sort__item--event">
        <input id="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT}" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT}" checked>
        <label class="trip-sort__btn" for="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT}">Event</label>
      </div>

      <div class="trip-sort__item  trip-sort__item--time">
        <input id="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME}" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME}">
        <label class="trip-sort__btn" for="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME}">
          Time
      ...
      <div class="trip-sort__item  trip-sort__item--price">
        <input id="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE}" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE}">
        <label class="trip-sort__btn" for="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE}">
          Price
          <svg class="trip-sort__direction-icon" width="8" height="10" viewBox="0 0 8 10">
            <path d="M2.888 4.852V9.694H5.588V4.852L7.91 5.068L4.238 0.00999987L0.548 5.068L2.888 4.852Z"/>
          </svg>
...
class Sort extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _setSortFieldName(sortType) {
    ...
    if (sortType !== _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT) {
...
const getChartConfig = (types, data, title, formatter) => {
  return {
    ...
    data: {
      ...
      datasets: [{
        data,
        backgroundColor: _const_js__WEBPACK_IMPORTED_MODULE_1__["chartOptions"].datasetsBackgroundColor,
        hoverBackgroundColor: _const_js__WEBPACK_IMPORTED_MODULE_1__["chartOptions"].datasetsHoverBackgroundColor,
        anchor: _const_js__WEBPACK_IMPORTED_MODULE_1__["chartOptions"].datasetsAnchor
      }]
    },
    options: {
      plugins: {
        datalabels: {
          font: {
            size: _const_js__WEBPACK_IMPORTED_MODULE_1__["chartOptions"].datalabelsFontSize
          },
          color: _const_js__WEBPACK_IMPORTED_MODULE_1__["chartOptions"].datalabelsColor,
          anchor: _const_js__WEBPACK_IMPORTED_MODULE_1__["chartOptions"].datalabelAnchor,
          align: _const_js__WEBPACK_IMPORTED_MODULE_1__["chartOptions"].datalabelAlign,
          formatter
        }
      },
      title: {
        display: true,
        text: title,
        fontColor: _const_js__WEBPACK_IMPORTED_MODULE_1__["chartOptions"].titleFontColor,
        fontSize: _const_js__WEBPACK_IMPORTED_MODULE_1__["chartOptions"].titleFontSize,
        position: _const_js__WEBPACK_IMPORTED_MODULE_1__["chartOptions"].titlePosition
      },
      scales: {
        yAxes: [{
          ticks: {
            fontColor: _const_js__WEBPACK_IMPORTED_MODULE_1__["chartOptions"].ticksFontColor,
            padding: _const_js__WEBPACK_IMPORTED_MODULE_1__["chartOptions"].ticksPadding,
            fontSize: _const_js__WEBPACK_IMPORTED_MODULE_1__["chartOptions"].ticksFontSize,
            callback: (type) => {
              return `${_const_js__WEBPACK_IMPORTED_MODULE_1__["typeIcons"][type]} ${type.toUpperCase()}`;
            },
          },
          gridLines: {
            display: false,
          ...
          barThickness: _const_js__WEBPACK_IMPORTED_MODULE_1__["chartOptions"].barThickness,
        }],
        xAxes: [{
          ticks: {
            display: false,
          ...
          minBarLength: _const_js__WEBPACK_IMPORTED_MODULE_1__["chartOptions"].minBarLength
        }],
      },
      legend: {
        display: false
...
const renderMoneyChart = (chart, points) => {
  ...
  const pointTypes = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["getPointsType"])(points);
  const data = pointTypes.map((type) => Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["calculateTypePrice"])(points, type));
  const setFormat = (val) => `€ ${val}`;

  chart.height = BAR_HEIGHT * pointTypes.length;

  return new chart_js__WEBPACK_IMPORTED_MODULE_3___default.a(chart, getChartConfig(pointTypes, data, _const_js__WEBPACK_IMPORTED_MODULE_1__["ChartTitle"].MONEY, setFormat));
};

const renderTransportChart = (chart, points) => {

  const pointTypes = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["getPointsType"])(points).filter((type) => (type !== `restaurant` && type !== `sightseeing` && type !== `check-in`));
  const data = pointTypes.map((type) => Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["calculateTypeCount"])(points, type));
  const setFormat = (val) => `${val}x`;

  chart.height = BAR_HEIGHT * pointTypes.length;

  return new chart_js__WEBPACK_IMPORTED_MODULE_3___default.a(chart, getChartConfig(pointTypes, data, _const_js__WEBPACK_IMPORTED_MODULE_1__["ChartTitle"].TRANSPORT, setFormat));
};

const renderTimeSpendChart = (chart, points) => {

  const pointTypes = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["getPointsType"])(points);
  const data = pointTypes.map((type) => Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["calculateTypeDuration"])(points, type));

  const setFormat = (val) => {
    return Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["setPointDurationFormat"])(val);
  };

  chart.height = BAR_HEIGHT * pointTypes.length;

  return new chart_js__WEBPACK_IMPORTED_MODULE_3___default.a(chart, getChartConfig(pointTypes, data, _const_js__WEBPACK_IMPORTED_MODULE_1__["ChartTitle"].TIME_SPEND, setFormat));
};
...
const createTitle = (points) => {
  ...
  if (pointsCount <= _const_js__WEBPACK_IMPORTED_MODULE_1__["COUNT_CITY_SHOWING"]) {
...
const createDates = (points) => {
  ...
  const startDate = moment__WEBPACK_IMPORTED_MODULE_3___default()(firstPoint.startTimestamp).format(`MMM D`);
  const endDate = moment__WEBPACK_IMPORTED_MODULE_3___default()(lastPoint.endTimestamp).format(`MMM D`);
...
class TripInfo extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getTemplate() {
    const points = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["getSortedPoints"])(this._pointsModel.getPoints(), _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT);
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: OFFERS_SHOWING, ONE_SECOND, ONE_MINUTE, ONE_HOUR, SHAKE_ANIMATION_TIMEOUT, COUNT_CITY_SHOWING, START_DAY_TIME, END_DAY_HOUR, END_DAY_MINUTE, END_DAY_MSEC, HIDDEN_CLASS, PointType, POINT_TYPES_TRANSPORT, POINT_TYPES_ACTIVITY, FilterType, MONTHS, KeyCode, SortType, Mode, MenuItem, ChartTitle, typeIcons, chartOptions, Method, EMPTY_POINT, DefaultData, URL, END_POINT, OFFERS_IF_PREFIX, STORE_PREFIX, STORE_VER, STORE_NAME */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OFFERS_SHOWING", function() { return OFFERS_SHOWING; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "COUNT_CITY_SHOWING", function() { return COUNT_CITY_SHOWING; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "START_DAY_TIME", function() { return START_DAY_TIME; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "END_DAY_HOUR", function() { return END_DAY_HOUR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "END_DAY_MINUTE", function() { return END_DAY_MINUTE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "END_DAY_MSEC", function() { return END_DAY_MSEC; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "POINT_TYPES_TRANSPORT", function() { return POINT_TYPES_TRANSPORT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "POINT_TYPES_ACTIVITY", function() { return POINT_TYPES_ACTIVITY; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "typeIcons", function() { return typeIcons; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EMPTY_POINT", function() { return EMPTY_POINT; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OFFERS_IF_PREFIX", function() { return OFFERS_IF_PREFIX; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "STORE_PREFIX", function() { return STORE_PREFIX; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "STORE_VER", function() { return STORE_VER; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "STORE_NAME", function() { return STORE_NAME; });
const OFFERS_SHOWING = 3;
const ONE_SECOND = 1000;
const ONE_MINUTE = 1000 * 60;
const ONE_HOUR = ONE_MINUTE * 60; // 1000 * 60 * 60
const SHAKE_ANIMATION_TIMEOUT = 600;
const COUNT_CITY_SHOWING = 3;
const START_DAY_TIME = 0;
const END_DAY_HOUR = 23;
const END_DAY_MINUTE = 59;
const END_DAY_MSEC = 999;
...
const OFFERS_IF_PREFIX = `event-offer`;
...
class FilterController {
  ...
  _isDisabled(type) {
    return Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_3__["getPointsByFilter"])(this._pointsModel.getPoints(), type).length > 0;
  }
  ...
  setActiveView(menuItem) {
    return menuItem === _const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].STATS ? this._filterComponent.setDisableInputs() : this._filterComponent.setEnableInputs();
  }
...
/* harmony import */ var _components_point_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/point.js */ "./src/components/point.js");
/* harmony import */ var _components_point_edit_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/point-edit.js */ "./src/components/point-edit.js");
...
const parseFormData = (formData, id, destinations, offers) => {
  ...
  const startTimestamp = parseInt(formData.get(`event-start-time`), 10) * _const_js__WEBPACK_IMPORTED_MODULE_5__["ONE_SECOND"];
  const endTimestamp = parseInt(formData.get(`event-end-time`), 10) * _const_js__WEBPACK_IMPORTED_MODULE_5__["ONE_SECOND"];
  ...
  const offersTypeAll = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getTypeOffers"])(offers, pointType); // все офферы типа

  const selectedOffers = offersTypeAll.filter((offer) => checkedOffersValues.includes(Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getOfferUID"])(offer.title, offer.price, id)));

  return new _models_point_js__WEBPACK_IMPORTED_MODULE_2__["default"]({
    id,
    "type": pointType,
    "base_price": price,
...
class PointController {
  constructor(container, onDataChange, onViewChange, onFavoriteChange, onCloseCreateForm = null, offers, destinations) {
    ...
    this._mode = _const_js__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT;
  ...
  render(point, offers, destinations, mode) {
    ...
    if (this._mode === _const_js__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING) {
      this._renderAddMode(_const_js__WEBPACK_IMPORTED_MODULE_5__["EMPTY_POINT"], offers, destinations, this._mode);
    } else {
  ...
  setDefaultView() {
    if (this._mode !== _const_js__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT) {
  ...
  destroy() {
    if (this._pointEditComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["remove"])(this._pointEditComponent);
    }
    if (this._pointComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["remove"])(this._pointComponent);
    }
  ...
  _renderDefaultOrEditMode(point, offers, destinations) {
    ...
    this._pointComponent = new _components_point_js__WEBPACK_IMPORTED_MODULE_0__["default"](point);
    this._pointEditComponent = new _components_point_edit_js__WEBPACK_IMPORTED_MODULE_1__["default"](point, offers, destinations);
    ...
    this._pointEditComponent.setFavoritesButtonClickHandler(() => {
      const newPoint = _models_point_js__WEBPACK_IMPORTED_MODULE_2__["default"].clone(point);
    ...
    switch (this._mode) {
      case _const_js__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT:
        if (oldPointComponent) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["replace"])(this._pointComponent, oldPointComponent);
        } else {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(this._container, this._pointComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].BEFOREEND);
        }
        break;

      case _const_js__WEBPACK_IMPORTED_MODULE_5__["Mode"].EDIT:
        if (oldPointEditComponent) {
          oldPointEditComponent.destroy();
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["replace"])(this._pointEditComponent, oldPointEditComponent);
        } else {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(this._container, this._pointEditComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].BEFOREEND);
        }
        document.addEventListener(`keydown`, this._onEscKeyDown);
        break;
    }
  ...
  _renderAddMode(point, offers, destinations) {
    ...
    this._pointEditComponent = new _components_point_edit_js__WEBPACK_IMPORTED_MODULE_1__["default"](point, offers, destinations, this._mode);
    ...
    document.addEventListener(`keydown`, this._onEscKeyDown);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(this._container, this._pointEditComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].AFTERBEGIN);
  }

  _replacePointToEdit() {
    this._onViewChange();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["replace"])(this._pointEditComponent, this._pointComponent);
    this._mode = _const_js__WEBPACK_IMPORTED_MODULE_5__["Mode"].EDIT;
  }

  _replaceEditToPoint() {
    document.removeEventListener(`keydown`, this._onEscKeyDown);
    this._pointEditComponent.reset();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["replace"])(this._pointComponent, this._pointEditComponent);
    this._mode = _const_js__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT;
  }

  shake() {
    this._pointEditComponent.getElement().style.animation = `shake ${_const_js__WEBPACK_IMPORTED_MODULE_5__["SHAKE_ANIMATION_TIMEOUT"] / _const_js__WEBPACK_IMPORTED_MODULE_5__["ONE_SECOND"]}s`;
    ...
    }, _const_js__WEBPACK_IMPORTED_MODULE_5__["SHAKE_ANIMATION_TIMEOUT"]);

    setTimeout(() => this._pointEditComponent.setErrorBorder(), _const_js__WEBPACK_IMPORTED_MODULE_5__["SHAKE_ANIMATION_TIMEOUT"]);
  }

  _onEscKeyDown(evt) {
    const isEscKey = evt.key === _const_js__WEBPACK_IMPORTED_MODULE_5__["KeyCode"].ESC || evt.key === _const_js__WEBPACK_IMPORTED_MODULE_5__["KeyCode"].ESCAPE;
...
/* harmony import */ var _components_days_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/days.js */ "./src/components/days.js");
/* harmony import */ var _components_day_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/day.js */ "./src/components/day.js");
/* harmony import */ var _components_points_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/points.js */ "./src/components/points.js");
...
const renderDay = (siteTripDayListElement, points, offers, destinations, onDataChange, onViewChange, onFavoriteChange, index = null, timestamp = null) => { // один день маршрута
  ...
  const siteTripDayElement = new _components_day_js__WEBPACK_IMPORTED_MODULE_2__["default"](timestamp, index);

  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(siteTripDayListElement.getElement(), siteTripDayElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND); // отрисовка trip-days__item

  const siteTripPointListElement = new _components_points_js__WEBPACK_IMPORTED_MODULE_3__["default"]();

  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(siteTripDayElement.getElement(), siteTripPointListElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND); // отрисовка trip-events__list

  return points.map((point) => {

    const pointController = new _point_controller_js__WEBPACK_IMPORTED_MODULE_5__["default"](siteTripPointListElement.getElement(), onDataChange, onViewChange, onFavoriteChange);

    pointController.render(point, offers, destinations, _const_js__WEBPACK_IMPORTED_MODULE_8__["Mode"].DEFAULT);
...
class TripController {
  constructor(container, pointsModel, api) {
    ...
    this._sortType = _const_js__WEBPACK_IMPORTED_MODULE_8__["SortType"].DEFAULT;
    this._createController = null;

    this._newPointBtn = document.querySelector(`.trip-main__event-add-btn`);

    this._pointControllers = [];
    this._pointsComponent = new _components_points_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._noPointsComponent = new _components_no_points_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._sortComponent = new _components_sort_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._daysComponent = new _components_days_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
  ...
  render(offers, destinations) {
    ...
    if (points.size === 0) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(this._container, this._noPointsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND); // отрисовка сообщения оо отсутствии точек
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(this._container, this._sortComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].AFTERBEGIN); // отрисовка сортировки
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(this._container, this._daysComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND); // отрисовка контейнера .trip-days

    this.renderContent();
  }

  hide() {
    this._container.classList.add(_const_js__WEBPACK_IMPORTED_MODULE_8__["HIDDEN_CLASS"]);
  }

  show() {
    this._container.classList.remove(_const_js__WEBPACK_IMPORTED_MODULE_8__["HIDDEN_CLASS"]);
  }
  ...
  createNewPoint() {
    ...
    this._createController = new _point_controller_js__WEBPACK_IMPORTED_MODULE_5__["default"](place, this._onDataChange, this._onViewChange, this._onFavoriteChange, this._onCloseCreateForm);
    this._createController.render(null, this._offers, this._destinations, _const_js__WEBPACK_IMPORTED_MODULE_8__["Mode"].ADDING);
  }
    ...
    this._api.updatePoint(oldData.id, newData)
      .then((pointModel) => {
        ...
        if (isSuccess) {
          ...
          pointController.render(pointModel, this._offers, this._destinations, _const_js__WEBPACK_IMPORTED_MODULE_8__["Mode"].EDIT);
        }
      })
      .catch(() => {
  ...
  _onDataChange(pointController, oldData, newData) {
    ...
    if (oldData.id === _const_js__WEBPACK_IMPORTED_MODULE_8__["EMPTY_POINT"].id) {
  ...
  renderContent() {
    this._destroy();
    if (this._sortType === _const_js__WEBPACK_IMPORTED_MODULE_8__["SortType"].DEFAULT) {
      const groupedPoints = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_7__["getPreparedPoints"])(this._pointsModel.getPoints(), this._sortType);
    ...
    const sortedPoints = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_7__["getSortedPoints"])(this._pointsModel.getPoints(), this._sortType);
...
/* harmony import */ var _controllers_trip_controller_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./controllers/trip-controller.js */ "./src/controllers/trip-controller.js");
...
/* harmony import */ var _components_stats_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/stats.js */ "./src/components/stats.js");
...
const AUTHORIZATION = `Basic e16w590wk271810`;

const api = new _api_api_js__WEBPACK_IMPORTED_MODULE_0__["default"](_const_js__WEBPACK_IMPORTED_MODULE_11__["END_POINT"], AUTHORIZATION);
const store = new _api_store_js__WEBPACK_IMPORTED_MODULE_2__["default"](_const_js__WEBPACK_IMPORTED_MODULE_11__["STORE_NAME"], window.localStorage);
const apiWithProvider = new _api_provider_js__WEBPACK_IMPORTED_MODULE_1__["default"](api, store);

const pointsModel = new _models_points_js__WEBPACK_IMPORTED_MODULE_9__["default"]();
const loadingComponent = new _components_loading_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
...
const tripInfoComponent = new _components_trip_info_js__WEBPACK_IMPORTED_MODULE_6__["default"](pointsModel);
const siteMenu = new _components_menu_js__WEBPACK_IMPORTED_MODULE_7__["default"]();

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(siteTripInformationElement, tripInfoComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].AFTERBEGIN); // контейнер для маршрута и стоимости .trip-main__trip-info
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(sitePageBodyContainerElement, loadingComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND); // отрисовка loading...

const siteControlsElement = siteHeaderElement.querySelector(`.trip-main__trip-controls`); // контейнер для меню и фильтра

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(siteControlsElement, siteMenu, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].AFTERBEGIN); // отрисовка меню

const filterController = new _controllers_filter_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](siteControlsElement, pointsModel);
filterController.render();

const sitePointContainerElement = siteContentElement.querySelector(`.trip-events`);

const tripController = new _controllers_trip_controller_js__WEBPACK_IMPORTED_MODULE_3__["default"](sitePointContainerElement, pointsModel, apiWithProvider);

const statisticComponent = new _components_stats_js__WEBPACK_IMPORTED_MODULE_8__["default"](pointsModel);

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(sitePageBodyContainerElement, statisticComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND); // отрисовка статистики
...
Promise.all([apiWithProvider.getPoints(), apiWithProvider.getOffers(), apiWithProvider.getDestinations()])
  .then(([points, offers, destinations]) => {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(loadingComponent);
...
class Point {
  ...
  toRAW() {
    return {
      ...
      "type": this.pointType,
      "date_from": Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getDateToRAW"])(this.startTimestamp),
...
class Points {
  ...
  getPoints() {
    return Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_0__["getPointsByFilter"])(this._points, this._activeFilterType);
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: castTimeFormat, getPointTime, getPointISOTime, getPointDurationFormat, setPointDurationFormat, getPointDuration, getSortedPoints, getGroupedPoints, getPreparedPoints, getPointsType, calculateTypeCount, calculateTypePrice, calculateTypeDuration, capitalizeFirstLetter, getTypeOffers, getDateToRAW, getOfferUID */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "castTimeFormat", function() { return castTimeFormat; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPointTime", function() { return getPointTime; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPointISOTime", function() { return getPointISOTime; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPointDurationFormat", function() { return getPointDurationFormat; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setPointDurationFormat", function() { return setPointDurationFormat; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPointDuration", function() { return getPointDuration; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSortedPoints", function() { return getSortedPoints; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getGroupedPoints", function() { return getGroupedPoints; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPreparedPoints", function() { return getPreparedPoints; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPointsType", function() { return getPointsType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "calculateTypeCount", function() { return calculateTypeCount; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "calculateTypePrice", function() { return calculateTypePrice; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "calculateTypeDuration", function() { return calculateTypeDuration; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "capitalizeFirstLetter", function() { return capitalizeFirstLetter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTypeOffers", function() { return getTypeOffers; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDateToRAW", function() { return getDateToRAW; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getOfferUID", function() { return getOfferUID; });
...
const getPointTime = (timestamp) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(timestamp).format(`HH:mm`);
};

const getPointISOTime = (timestamp) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(timestamp).format(`YYYY-mm-DTHH:mm`);
};

const getPointDurationFormat = (start, end) => {
  const pointStart = moment__WEBPACK_IMPORTED_MODULE_0___default()(start);
  const pointEnd = moment__WEBPACK_IMPORTED_MODULE_0___default()(end);
  const duration = pointEnd.diff(pointStart); // продолжительность точки

  return setPointDurationFormat(duration);
};

const setPointDurationFormat = (duration) => {
  const pointDurDay = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(duration).days(); // количество дней
  const pointDurHour = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(duration).hours(); // количество часов
  const pointDurMin = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(duration).minutes(); // количество минут
...
const getPointDuration = (start, end) => {
  const pointStart = moment__WEBPACK_IMPORTED_MODULE_0___default()(start);
  const pointEnd = moment__WEBPACK_IMPORTED_MODULE_0___default()(end);
...
const getSortedPoints = (points, sortType) => {
  ...
  switch (sortType) {
    case _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT:
...
const getGroupedPoints = (points) => {
  const pointsGroups = new Map();
  points.forEach((point) => {
    const startPointDate = new Date(point.startTimestamp);

    const startDay = new Date(startPointDate.getFullYear(), startPointDate.getMonth(), startPointDate.getDate(), _const_js__WEBPACK_IMPORTED_MODULE_1__["START_DAY_TIME"], _const_js__WEBPACK_IMPORTED_MODULE_1__["START_DAY_TIME"], _const_js__WEBPACK_IMPORTED_MODULE_1__["START_DAY_TIME"], _const_js__WEBPACK_IMPORTED_MODULE_1__["START_DAY_TIME"]);
    const endDay = new Date(startPointDate.getFullYear(), startPointDate.getMonth(), startPointDate.getDate(), _const_js__WEBPACK_IMPORTED_MODULE_1__["END_DAY_HOUR"], _const_js__WEBPACK_IMPORTED_MODULE_1__["END_DAY_MINUTE"], _const_js__WEBPACK_IMPORTED_MODULE_1__["END_DAY_MINUTE"], _const_js__WEBPACK_IMPORTED_MODULE_1__["END_DAY_MSEC"]);
...
const getPreparedPoints = (points, sortType = _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT) => {
...
const calculateTypeCount = (points, type) => {
  return points.filter((it) => it.pointType === type).length;
};

const calculateTypePrice = (points, type) => {
...
const calculateTypeDuration = (points, type) => {
  ...
  return moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(chartDurationPointsTimestamp).asMilliseconds();
};
...
const getTypeOffers = (offers, typeName) => {
...
const getDateToRAW = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).toJSON();
};

const getOfferUID = (title, price, id) => {
  return `${_const_js__WEBPACK_IMPORTED_MODULE_1__["OFFERS_IF_PREFIX"]}-${title}-${price}-${id}`;
};
